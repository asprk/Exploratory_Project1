...
plot(power_consumption$diff,power_consumption$Global_active_power,type="l",xlab="",ylab="Global Active Power (Kilowatts)",xaxt="n")
axis(1,at=c(0,86400,172800),labels=c("Thu","Fri","Sat"))

plot(power_consumption$diff,power_consumption$Voltage,type="l",xlab="date time",ylab="Voltage",xaxt="n")
axis(1,at=c(0,86400,172800),labels=c("Thu","Fri","Sat"))

with(power_consumption,plot(diff,Sub_metering_1,type="l",xlab="",ylab="Energy sub metering",xaxt="n"))
...
plot(power_consumption$diff,power_consumption$Global_reactive_power,type="l",xlab="date time",ylab="Global_reactive_power",xaxt="n")
axis(1,at=c(0,86400,172800),labels=c("Thu","Fri","Sat"))
